...
public class RegistroProfesores extends JFrame {
	...
	public RegistroProfesores() {
		...
		lblDni = new JLabel("Numero :");
		lblDni.setBounds(370, 404, 104, 16);
		lblDni.setFont(new Font("Tahoma", Font.BOLD, 18));
		contentPane.add(lblDni);
		
		textField_3 = new JTextField();
		textField_3.setBounds(500, 403, 116, 22);
		textField_3.setColumns(10);
		contentPane.add(textField_3);
		
		lblGrupo = new JLabel("Tel\u00E9fono :");
		lblGrupo.setBounds(370, 347, 104, 19);
		lblGrupo.setFont(new Font("Tahoma", Font.BOLD, 18));
		contentPane.add(lblGrupo);
		
		textField_4 = new JTextField();
		textField_4.setBounds(500, 347, 116, 22);
		...
		JLabel lblListadoDeAlumnos = new JLabel("Registro Profesores");
		...
		lblMail = new JLabel("Mail1 :");
		lblMail.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblMail.setBounds(370, 459, 104, 16);
		contentPane.add(lblMail);
		
		lblMail_1 = new JLabel("Mail2 :");
		lblMail_1.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblMail_1.setBounds(370, 510, 104, 16);
		contentPane.add(lblMail_1);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(500, 458, 116, 22);
		contentPane.add(textField_1);
		
		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(500, 509, 116, 22);
