...
public class ListadosAlumnos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadosAlumnos frame = new ListadosAlumnos();
	...
	public ListadosAlumnos() {
		...
		JLabel lblAcad = new JLabel("N\u00FAmero :");
		lblAcad.setBounds(113, 459, 85, 16);
		...
		JLabel lblListadoDeAlumnos = new JLabel("Listado de Profesores");
		...
		JLabel lblMail_1 = new JLabel("Mail1 :");
		lblMail_1.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblMail_1.setBounds(630, 407, 104, 19);
		contentPane.add(lblMail_1);
		
		JLabel lblMail = new JLabel("Mail2 :");
		lblMail.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblMail.setBounds(630, 458, 104, 19);
		contentPane.add(lblMail);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(723, 407, 116, 22);
